...
int backgroundholder = -1;
		...
		//10. if the mouse is on the end color
				if (mouseColor==-1310720) {
					
				
				// pop up a message to tell them they won
		JOptionPane.showMessageDialog(null, "You won now kys");
	}
	}
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("die.wav"));
